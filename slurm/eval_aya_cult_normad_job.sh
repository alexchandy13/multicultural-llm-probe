#!/bin/bash
#SBATCH --job-name=culture_eval_aya_cult_normad
...
#SBATCH --array=0-3
#SBATCH --output=slurm/eval_aya_cult_normad.%A_%a.out
#SBATCH --error=slurm/eval_aya_cult_normad.%A_%a.err

# NormAd eval for Aya cultural split conditions (sft/sftdpo × cult/nocult), Llama 3.1 8B.
# Requires sft_aya_cult_8b, sft_aya_nocult_8b, sftdpo_aya_cult_8b, sftdpo_aya_nocult_8b
# checkpoints to exist.
# Submit with: sbatch slurm/eval_aya_cult_normad_job.sh
...
echo "[eval_aya_cult_normad] condition=$COND"
