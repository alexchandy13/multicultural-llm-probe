...
Usage:
    ...
    python3.12 health/check_checkpoint.py checkpoints/sft

    # Specify a different base (e.g. to check a Llama-3.1 adapter):
    python3.12 health/check_checkpoint.py --base meta-llama/Llama-3.1-8B-Instruct path/to/ckpt

    # Skip 4-bit if bitsandbytes is misbehaving:
    python3.12 health/check_checkpoint.py --no-quant checkpoints/sft
"""
